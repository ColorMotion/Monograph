\documentclass[12pt,openright,oneside,a4paper,english]{abntex2}
    ...
    %TODO: diagrama de exemplo de \acrshort{cnn}? Se muito rolo referenciar a do colorful la na frente é opção - slides
    %TODO:encoder-decoder! - sim
    ...
    %TODO: citar transf. de estilo Microsoft (precisa mesmo?)
